...
public class MapotempoCategoriesAdapter extends BaseBookmarkCategoryAdapter<MapotempoCategoriesAdapter.ViewHolder>
{
  ...
  public MapotempoCategoriesAdapter(Context context)
  {
    super(context);
    mContext = context;
  }
